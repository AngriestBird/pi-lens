...
- `~/.pi-lens/review-graph.log` — NDJSON review-graph build and persistence outcomes; lifecycle entries carry bounded build/persist generations, sequence hints, counts/timestamps, and coalescing/supersession/fallback status without source contents
