...
pi-lens bundles **447 enabled** ast-grep rules (263 pi-lens-authored + 184 vendored from CodeRabbit) across **16 languages**, plus 16 disabled.
...
| `no-bare-object-param` | warning | pi-lens | Parameter typed bare 'object' — guarantees nothing about shape, use Record<string, unknown> or a real interface |
