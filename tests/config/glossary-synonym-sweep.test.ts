...
const PINS: Readonly<Record<string, Readonly<Record<string, number>>>> = {
	...
	error: {
		...
		"clients/dispatch/runners/ktlint.ts": 1,
	...
	path: {
		...
		"clients/dispatch/runners/biome-check.ts": 1,
		"clients/dispatch/runners/cpp-check.ts": 7,
		"clients/dispatch/runners/credo.ts": 5,
		"clients/dispatch/runners/cue-vet.ts": 5,
		"clients/dispatch/runners/dart-analyze.ts": 6,
		...
		"clients/dispatch/runners/htmlhint.ts": 2,
		...
		"clients/dispatch/runners/stylelint.ts": 3,
		"clients/dispatch/runners/swiftlint.ts": 2,
		"clients/dispatch/runners/taplo.ts": 2,
		"clients/dispatch/runners/terragrunt.ts": 6,
		"clients/dispatch/runners/tflint.ts": 5,
		"clients/dispatch/runners/tree-sitter.ts": 2,
		"clients/dispatch/runners/trivy-config.ts": 2,
		"clients/dispatch/runners/utils/runner-helpers.ts": 23,
		"clients/dispatch/runners/vale.ts": 5,
	...
	status: {
		...
		"clients/dispatch/runners/eslint.ts": 9,
		...
		"clients/dispatch/runners/golangci-lint.ts": 7,
		...
		"clients/dispatch/runners/ktlint.ts": 11,
		...
		"clients/dispatch/runners/php-lint.ts": 6,
		"clients/dispatch/runners/phpstan.ts": 4,
