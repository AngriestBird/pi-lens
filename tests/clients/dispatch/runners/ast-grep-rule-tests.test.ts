...
d("shipped ast-grep rules have fixture-style valid/invalid tests", () => {
	...
	// All language families get fixture coverage (TS, TSX, JS, Python, Rust, Go, Java).
	...
	it("every rule (TS/TSX/JS/Python/Rust/Go/Java) has a corresponding -test.yml fixture", () => {
