...
> = {
	...
	// 2026-09-15 (#2154 AC1): 1 -> 3. The reported defect needs TWO LIVE pi
	// sessions over one project root and one PI_LENS_HOME — the durable stores
	// they share are keyed by exactly that pair, so one child (or a pair of
	// in-process doubles) cannot reach the crossing at all.
